...
async function searchGoogle(page, query) {
  try {
    ...
    await sleep(randInt(3000, 5000));  // Esperar más
...
(async()=>{
        ...
        // Importar dinamicamente PDFMerger (módulo ESM)
   ...
   // for (let i = 0; i < 1; i++) {
        ...
        // Iniciar navegador UNA SOLA VEZ (reutilizar para todas las búsquedas)
        ...
        for (let i = 0; i < datas.length; i++) {
          ...
          // Usar la función searchGoogle mejorada
          ...
          // Pausa entre búsquedas (5-15 seg) para parecer más humano
          if (i < datas.length - 1) {
        ...
        await merger.save(dir_resultado+'/Consulta_Google_General_'+String(fecha_hoy)+'.pdf'); //save under given
